...
use vc_tui::config::{default_state_root, default_vibecrafted_home};
use vc_tui::mission_control::{self as mc, MissionControlState};
use vc_tui::state::ControlPlaneState;
...
// `vc_tui::mission_control::*` without duplicating the
